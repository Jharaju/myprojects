...
$qf= "SELECT firstname, lastname, profile_pic FROM profile_users WHERE id= :ed";
...
?>
                                ...
                                <img src="images/<?php if(! isset($_SESSION['itself'])){if(isset($_SESSION['id'])){if(! isset($_SESSION['one'])){echo $resultf['profile_pic'];}}} ?>" alt= ""> <p id="uname"><?php if(! isset($_SESSION['itself'])){if(isset($_SESSION['id'])){if(! isset($_SESSION['one'])){echo $resultf['firstname']." ".$resultf['lastname'];}}} ?></p>
                            <?php } ?>
                            </div>
...
?>
                    ...
                    <div class="name"><?php echo $result['firstname']. ' '. $result['lastname']; ?></div></div> <button class="chat_button" data-mid="<?php echo $id; ?>">Message Me</button>
                        
                    <?php 
                    if(isset($_SESSION['id'])){
                if($result['id'] === $_SESSION['id']){
                    $_SESSION['mine']= $result['id'];
                }    
                }
            }
            }
                ...
                <?php
                    if(isset($_SESSION['mine'])){
                        if($_SESSION['mine']=== $_SESSION['id']){
                            ?>

                            <?php
                            
                        // $q1= "SELECT id, firstname, lastname, profile_pic FROM profile_users WHERE id= (SELECT id FROM messages WHERE where_to= :mine)";
